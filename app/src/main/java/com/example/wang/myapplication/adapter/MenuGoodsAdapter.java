...
public class MenuGoodsAdapter extends RecyclerView.Adapter<MenuGoodsAdapter.MainCardHolder> {
    ...
    public class MainCardHolder extends RecyclerView.ViewHolder {
        ...
        public void setDate() {
            ...
            card_goods.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ActivityOptionsCompat options =  ActivityOptionsCompat.makeSceneTransitionAnimation( com.example.wang.myapplication.view.activity.MainActivity.instance,
        ...
        private void toLoveOne_Activity(Love love, String bg) {
            Intent intent = new Intent(context,  com.example.wang.myapplication.view.activity.LoveOne_ActivityView.class);
