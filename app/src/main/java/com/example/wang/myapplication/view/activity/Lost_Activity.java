...
import  com.example.wang.myapplication.utils.CopyText;
...
public class Lost_Activity extends AppCompatActivity {
    ...
    @BindView(R.id.tv_lost_title)
    TextView tvLostTitle;
    @BindView(R.id.tv_lost_infor)
    TextView tvLostInfor;
    @BindView(R.id.tv_lost_things)
    TextView tvLostThings;
    @BindView(R.id.tv_lost_where)
    TextView tvLostWhere;
    @BindView(R.id.tv_lost_name)
    TextView tvLostName;
    @BindView(R.id.tv_lost_complete)
    TextView tvLostComplete;
    @BindView(R.id.tv_lost_time)
    TextView tvLostTime;
    @BindView(R.id.tv_lost_linktel)
    TextView tvLostLinktel;
    @BindView(R.id.ll_lost_tel)
    LinearLayout llLostTel;
    @BindView(R.id.tv_lost_linkqq)
    TextView tvLostLinkqq;
    @BindView(R.id.ll_lost_qq)
