...
public class LoveCommentAdapter extends RecyclerView.Adapter<LoveCommentAdapter.MainCardHolder> {
    ...
    public class MainCardHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.image_lovecomment_headpic)
        ImageView imageLovecommentHeadpic;
        @BindView(R.id.tv_lovecomment_floor)
        TextView tvLovecommentFloor;
        @BindView(R.id.tv_lovecomment_username)
        TextView tvLovecommentUsername;
        @BindView(R.id.tv_lovecomment_time)
        TextView tvLovecommentTime;
        @BindView(R.id.tv_lovecomment_content)
        TextView tvLovecommentContent;
        @BindView(R.id.card_lovecomment)
        CardView cardView;
        ...
        public void setDate() {
            ...
            Glide.with(context)
                    .load(head)
                    .centerCrop()
                    .transform(new com.example.wang.myapplication.utils.GlideCircleTransform(context))
