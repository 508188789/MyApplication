...
public class SkinActivity extends AppCompatActivity {
    ...
    private void savetheme(int mtheme,String color) {
        Application.settheme(mtheme);
         com.example.wang.myapplication.utils.FileTools.saveshareInt("theme", mtheme);
         com.example.wang.myapplication.utils.FileTools.saveshareString("refreshcolor", color);//保存一个颜色，用来设置下拉刷新的颜色
