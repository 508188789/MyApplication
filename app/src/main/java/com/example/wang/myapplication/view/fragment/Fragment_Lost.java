...
import  com.example.wang.myapplication.adapter.LostAdapter;
...
//        }
        query.findObjects(new FindListener<Lost>() {
            ...
            public void done(List<Lost> list, BmobException e) {
                showrefresh(false);
                if (e != null) {
                     com.example.wang.myapplication.utils.Toast.show("查询失物招领出错：" + e.toString());
...
//        }
        bmobQuery.findObjects(new FindListener<Lost>() {
            ...
            public void done(List<Lost> list, BmobException e) {
                showrefresh(false);
                if (e != null) {
                     com.example.wang.myapplication.utils.Toast.show("查询更多失物招领出错：" + e.toString());
