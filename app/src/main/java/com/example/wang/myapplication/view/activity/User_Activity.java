...
import  com.example.wang.myapplication.presenter.User_ActivityPresenter;
...
public class User_Activity extends AppCompatActivity implements IUserActivityView {
    ...
    @BindView(R.id.tv_user_school_state)
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.card_user_phone:
                startActivity(new Intent(context,  com.example.wang.myapplication.view.activity.LoginPhone_Activity.class));
                break;
