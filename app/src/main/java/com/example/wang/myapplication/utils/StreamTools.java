...
import com.example.wang.myapplication.modle.bean.CardClass;
import com.example.wang.myapplication.modle.bean.CourseClass;
import com.example.wang.myapplication.modle.bean.Love;
import com.example.wang.myapplication.modle.bean.Score2Class;
import com.example.wang.myapplication.modle.bean.ScoreClass;
...
//			Log.e("借书记录",ele2.toString() +"#");
    ...
    public static List<CourseClass> gettodaycourse() {
        try {
            ...
            int xq = com.example.wang.myapplication.utils.TimeTools.xq();
