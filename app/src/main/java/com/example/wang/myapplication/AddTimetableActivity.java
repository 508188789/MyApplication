...
import com.example.wang.myapplication.adapter.SelectWeekAdapter;
import com.example.wang.myapplication.modle.AddModel;
...
public class AddTimetableActivity extends Activity {
    ...
    private void initsData() {
        ...
        if(curScheduleNameId==-1){
            ...
            if(itemView!=null){
                TextView time = (TextView)itemView.findViewById(R.id.et_time);
    ...
    public void addOneItem() {
        ...
        weeksLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
