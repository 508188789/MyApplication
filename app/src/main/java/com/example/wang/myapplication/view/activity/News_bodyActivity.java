...
public class News_bodyActivity extends AppCompatActivity {
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    Elements element1 = doc1.select("div#v_news_content");
                    Document doc2 = Jsoup.parse(element1.toString());
                    Log.i("内容",element1.toString());
                    Elements element2 = doc1.select("p");
    ...
    public void click_open(View view) {
         com.example.wang.myapplication.utils.PublicTools.openhtml(context,link);
    }
