...
import  com.example.wang.myapplication.adapter.GoodsAdapter;
...
public class Fragment_Goods extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context = getActivity();
         com.example.wang.myapplication.view.activity.MainActivity.setToolBarVisibale(false);
        select_name = "";
        ...
        tabLayout.setBackgroundColor(Color.parseColor( com.example.wang.myapplication.utils.FileTools.getshareString("refreshcolor")));
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        GoodsAdapter.Itemclick itemclick = new GoodsAdapter.Itemclick() {
            public void OnItemclick(View v, int position) {
                ...
                Intent intent = new Intent(context,  com.example.wang.myapplication.view.activity.Goods_Activity.class);
        ...
        public void setnewData() {
            ...
            bmobQuery.findObjects(new FindListener<Good>() {
                ...
                public void done(List<Good> list, BmobException e) {
                    ...
                    if (list.size() == 0) {
                         com.example.wang.myapplication.utils.Toast.show("没有更多的内容啦~");
                        return;
                    }
    ...
    private void setinter() {
         com.example.wang.myapplication.view.activity.MainActivity mainActivity = ( com.example.wang.myapplication.view.activity.MainActivity) getActivity();
        mainActivity.setFabClickedListener_cx(new  com.example.wang.myapplication.view.activity.MainActivity.OnFabClickedListener() {
            @Override
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!"".equals(select_name)) {
                     com.example.wang.myapplication.utils.Toast.show("暂时不能查询");
                }
            }
        });
        builder.create().show();
