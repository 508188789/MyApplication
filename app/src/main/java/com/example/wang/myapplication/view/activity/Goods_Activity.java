...
public class Goods_Activity extends AppCompatActivity {
    ...
    @BindView(R.id.tv_goods_linktel)
    TextView tvGoodsLinktel;
    @BindView(R.id.tv_goods_linkqq)
    ...
    @BindView(R.id.ll_goods_tel)
    LinearLayout llGoodsTel;
    @BindView(R.id.ll_goods_qq)
    LinearLayout llGoodsQq;
    @BindView(R.id.tv_goods_knife)
    TextView tvGoodsKnife;
    @BindView(R.id.tv_goods_complete)
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_goods_copy:
               // CopyText.settext(good.getLink_qq());
                PublicTools.qqchat(context,good.getLink_qq());
                break;
        }
    }
