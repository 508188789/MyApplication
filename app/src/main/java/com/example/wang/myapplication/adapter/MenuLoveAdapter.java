...
import com.example.wang.myapplication.view.activity.Add_loveActivity;
import com.example.wang.myapplication.view.activity.LoveOne_ActivityView;
...
public class MenuLoveAdapter extends RecyclerView.Adapter<MenuLoveAdapter.MainCardHolder> {
    ...
    public class MainCardHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.img_love_left)
        AppCompatImageView imgLeft;
        @BindView(R.id.img_love_right)
        AppCompatImageView imgRight;

        @BindView(R.id.tx_lovemenu_object)
        TextView txLovemenuObject;
        @BindView(R.id.tx_lovemenu_content)
        TextView txLovemenuContent;
        @BindView(R.id.tx_lovemenu_name)
        TextView txLovemenuName;
        @BindView(R.id.tv_lovemenu_like)
        TextView tvLovemenuLike;
        @BindView(R.id.tv_lovemenu_comment)
        TextView tvLovemenuComment;
        @BindView(R.id.tv_lovemenu_tiem)
        TextView tvLovemenuTiem;
        @BindView(R.id.sb_lovemenu_like)
        ShineButton sbLovemenuLike;
        @BindView(R.id.sb_lovemenu_comment)
        ShineButton sbLovemenuComment;
        @BindView(R.id.sb_lovemenu_love)
        ShineButton sbLovemenuLove;
        @BindView(R.id.ll_lovemenu)
        LinearLayout linearLayout;
        @BindView(R.id.ll_lovemenu_below)
        LinearLayout linearLayoutbelow;
        private int[] lovehead = {R.drawable.love1,R.drawable.love2,R.drawable.love3,R.drawable.love4,R.drawable.love5,R.drawable.love6,R.drawable.love7,R.drawable.love8};
...
//            Log.d("tip", getAdapterPosition() + "长度：" + list.size());
            if (love == null) {
                ...
                linearLayout.setBackgroundResource(R.drawable.ic_down);
                ...
                imgRight.setVisibility(View.GONE);
                imgLeft.setImageResource(lovehead[(getAdapterPosition()%8)]);
            }else {
                imgLeft.setVisibility(View.GONE);
                imgRight.setImageResource(lovehead[(getAdapterPosition()%8)]);
            }
